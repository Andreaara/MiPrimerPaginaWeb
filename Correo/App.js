...
function validarDatos() {
    ...
    if (correoValor === "" && contraseniaValor === "") {
        resultadoDiv.innerHTML = "<p>Ingresa un correo y una contraseña.</p>";
    } else if (correoValor === "") {
        resultadoDiv.innerHTML = "<p>No has ingresado un correo.</p>";
    } else if (contraseniaValor === "") {
        resultadoDiv.innerHTML = "<p>No has ingresado una contraseña.</p>";
    } else {
